...
`;
    ...
    function flagRevision(rev) {
        ...
        var flagWindow =
            ...
            '<option value="better_nutriscore">better_nutriscore</option>' +
            '<option value="better_nova">better_nova</option>' +
            '<option value="worse_nutriscore">worse_nutriscore</option>' +
            '<option value="worse_nova">worse_nova</option>' +
            '<option value="less_additives">less_additives</option>' +
            '<option value="more_additives">more_additives</option>' +
            '<option value="less_salt">less_salt</option>' +
            '<option value="less_fat">less_fat</option>' +
            '<option value="less_sugar">less_sugar</option>' +
            '<option value="more_salt">more_salt</option>' +
            '<option value="more_fat">more_fat</option>' +
            '<option value="more_sugar">more_sugar</option>' +
            '<option disabled="disabled">----</option>'+
